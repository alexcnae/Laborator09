...
public interface Constants {
    ...
    final public static String USERNAME = "alexandru";
    final public static String IDENTITY_IMPI = "upb_alexcnae";
    final public static String IDENTITY_PASSWORD = "CzuYGabzjsDq8Vbd";
    final public static String DOMAIN = "upb-alexcnae.onsip.com";
    final public static String NETWORK_PCSCF_HOST = "sip.onsip.com";
    final public static int NETWORK_PCSCF_PORT = 5060;
    final public static String NETWORK_REALM = "upb-alexcnae.onsip.com";
